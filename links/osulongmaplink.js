...
module.exports = {
  ...
  execute(
    ...
    if (
      message.content.includes("mania") ||
      message.content.includes("fruits") ||
      message.content.includes("taiko")
    )
      return;
    try {
      const w = JSON.stringify(linkargs)
        .replaceAll("https", "")
        .replaceAll(":", "")
        .replaceAll("//", "")
        .replaceAll("osu.ppy.sh", "")
        .replaceAll("beatmapsets")
        .replaceAll("/", "")
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll('"', "")
      ...
      const pickeduserX = JSON.stringify(grab)
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll('"', "")
        .replaceAll("osu", "")
      ...
      fetch(mapurl, {
        ...
        .then((output2) => {
          ...
          try {
            ...
            let mapper = JSON.stringify(mapdata["beatmapset"], ["creator"])
              .replaceAll("{", "")
              .replaceAll('"', "")
              .replaceAll("}", "")
              .replaceAll(":", "")
            ...
            let maptitlenorm = JSON.stringify(mapdata["beatmapset"], ["title"])
              .replaceAll("{", "")
              .replaceAll('"', "")
              .replaceAll("}", "")
              .replaceAll(":", "")
            ...
            let topacc = Math.abs(100.0);
            let midacc = Math.abs(95.0);
            ...
            (async () => {
              ...
              let ppSSstr = parseFloat(
                JSON.stringify(ppSSjson["total"])
              ).toFixed(2);
              let pp95str = parseFloat(
                JSON.stringify(pp95json["total"])
              ).toFixed(2);
