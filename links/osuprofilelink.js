...
module.exports = {
  ...
  execute(
    ...
    const w = JSON.stringify(linkargs[0])
      .replaceAll("https", "")
      .replaceAll(":", "")
      .replaceAll("//", "")
      .replaceAll("osu.ppy.sh", "")
      .replace("users", "")
      .replace("u")
      .replaceAll("/", "")
      .replaceAll("[", "")
      ...
      .then((output2) => {
        try {
          ...
          let playerid = JSON.stringify(osudata, ["id"])
            ...
            .replaceAll(":", "")
            .replaceAll("id", "");
          let playeravatar = JSON.stringify(osudata, ["avatar_url"])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replaceAll(":", "")
            .replaceAll("avatar_url", "")
            .replaceAll("https", "https:");
          let playerrank1 = JSON.stringify(osudata["statistics"], [
            "global_rank",
          ])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replaceAll(":", "")
            .replaceAll("global_rank", "");
          let playercountryrank = JSON.stringify(osudata["statistics"], [
            "country_rank",
          ])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replaceAll(":", "")
            .replaceAll("country_rank", "");
          let playercountry = JSON.stringify(osudata, ["country_code"])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replaceAll(":", "")
            .replaceAll("country_code", "");
          let playerpp = JSON.stringify(osudata["statistics"], ["pp"])
            ...
            .replaceAll(":", "")
            .replaceAll("pp", "");
          let playerplays = JSON.stringify(osudata["statistics"], [
            "play_count",
          ])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replaceAll(":", "")
            .replaceAll("play_count", "");
          let playerlevel = JSON.stringify(osudata["statistics"]["level"], [
            "current",
          ])
            .replaceAll("{", "")
            .replaceAll('"', "")
          ...
          let playeraccuracy = JSON.stringify(osudata["statistics"], [
            "hit_accuracy",
          ])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replaceAll(":", "")
            .replaceAll("hit_accuracy", "")
            .slice(0, 5);
          let playeracount = JSON.stringify(
            osudata["statistics"]["grade_counts"],
            ["a"]
          )
            .replaceAll("{", "")
            .replaceAll('"', "")
            ...
            .replaceAll(":", "")
            .replaceAll("a", "");
          let playerscount = JSON.stringify(
            osudata["statistics"]["grade_counts"],
            ["s"]
          )
            .replaceAll("{", "")
          ...
          let playershcount = JSON.stringify(
            ...
            .replaceAll(":", "")
            .replaceAll("sh", "");
          let playerxcount = JSON.stringify(
            osudata["statistics"]["grade_counts"],
            ["ss"]
          )
            .replaceAll("{", "")
          ...
          let playerfollowers = JSON.stringify(osudata, ["follower_count"])
            ...
            .replaceAll("}", "")
            .replaceAll(":", "")
            .replaceAll("follower_count", "");
          let playerprevname = JSON.stringify(osudata, ["previous_usernames"])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replaceAll(":", "")
            .replaceAll("previous_usernames", "")
            .replaceAll("[", "")
            .replaceAll("]", "");

          let playerrank = JSON.stringify(osudata["statistics"], [
            "global_rank",
          ])
            .replaceAll("{", "")
            .replaceAll('"', "")
          ...
          let playerlast = JSON.stringify(osudata, ["last_visit"])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replace(":", "")
            .replaceAll("last_visit", "")
            .replaceAll("[", "")
            .replaceAll("]", "");
            ...
            let Embed = new Discord.MessageEmbed()
              ...
              .setDescription(
                "**Global Rank:** " +
                  ...
                  "\n**Previous names:** " +
                  playerprevname +
                  "\n<:rankingxh:927797179597357076>" +
                  playerxhcount +
                  " <:rankingX:927797179832229948>" +
                  playerxcount +
                  " <:rankingSH:927797179710570568>" +
                  playershcount +
                  " <:rankingS:927797179618295838>" +
                  playerscount +
                  " <:rankingA:927797179739930634>" +
                  playeracount
              );
