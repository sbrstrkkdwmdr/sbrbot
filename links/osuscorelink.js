...
module.exports = {
  ...
  execute(
    ...
    let pickeduserX = linkargs[0]
      .replace("https://", "")
      .replace("osu.ppy.sh/scores/", "")
      .replace("osu/", "")
      .replace("fruits/", "")
      .replace("taiko/", "")
      .replace("mania/", "");
    ...
    fetch(getscoreurl, {
      ...
      .then((output2) => {
        try {
          ...
          fs.appendFileSync(linkfetchlogdir, "\n" + "");
          let playername = JSON.stringify(scoredata["user"], ["username"])
            .replace("username", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
          ...
          let playerid = JSON.stringify(scoredata["user"], ["id"])
            .replace("id", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let hitmax = JSON.stringify(scoredata["statistics"], ["count_geki"])
            .replace("count_geki", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let hit300 = JSON.stringify(scoredata["statistics"], ["count_300"])
            .replace("count_300", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let hit200 = JSON.stringify(scoredata["statistics"], ["count_katu"])
            .replace("count_katu", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let hit100 = JSON.stringify(scoredata["statistics"], ["count_100"])
            .replace("count_100", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let hit50 = JSON.stringify(scoredata["statistics"], ["count_50"])
            .replace("count_50", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let hit0 = JSON.stringify(scoredata["statistics"], ["count_miss"])
            .replace("count_miss", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let timeset = JSON.stringify(scoredata["created_at"])
            .replace("created_at", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let mapid = JSON.stringify(scoredata["beatmap"], ["id"])
            .replace("id", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let maptitle = JSON.stringify(scoredata["beatmapset"], ["title"])
            .replace("title", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", ""); //.replace('undefined', '')
          let maptitleunicode = JSON.stringify(scoredata["beatmapset"], [
            "title_unicode",
          ])
            ...
            .replaceAll('"', "")
            .replace(":", "");
          let mapdiff = JSON.stringify(scoredata["beatmap"], ["version"])
            .replace("version", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let scoremods = JSON.stringify(scoredata["mods"])
            .replace("mods", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            ...
            .replace("]", "")
            .replaceAll(",", "");
          let scorepp = JSON.stringify(scoredata["pp"])
            .replace("pp", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let acc = JSON.stringify(scoredata["accuracy"])
            .replace("accuracy", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let scorecombo = JSON.stringify(scoredata["max_combo"])
            .replace("max_combo", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let fc = JSON.stringify(scoredata["perfect"])
            .replace("perfect", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let grade = JSON.stringify(scoredata["rank"])
            .replace("rank", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");
          let mapsr = JSON.stringify(scoredata["beatmap"], [
            "difficulty_rating",
          ])
            .replace("difficulty_rating", "")
            .replace("{", "")
            .replace("}", "")
            .replaceAll('"', "")
            .replace(":", "");

          let mapbg = JSON.stringify(scoredata["beatmapset"]["covers"], [
            "cover",
          ])
            .replaceAll("{", "")
            .replaceAll('"', "")
          ...
          (async () => {
            ...
            let embed = new Discord.MessageEmbed()
              ...
              .addField(
                "MAP DETAILS",
                `**[${mapname} [${mapdiff}]](https://osu.ppy.sh/b/${mapid})** ${modsz} ${SRclean}⭐`,
                false
              )
              .addField(
                "SCORE DETAILS",
