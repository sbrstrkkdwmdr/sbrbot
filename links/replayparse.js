...
module.exports = {
  ...
  execute(
    ...
    try {
      ...
      let lifebar = JSON.stringify(replay, ["life_bar"])
        .replaceAll("{", "")
        .replaceAll('"', "")
        .replaceAll("}", "")
        .replaceAll(":", "")
      ...
      let bettertimeset = JSON.stringify(replay, ["timestamp"])
        ...
        .replaceAll("timestamp", "")
        .slice(0, 10);
      let gamemode = JSON.stringify(replay, ["gameMode"])
        .replaceAll("{", "")
        .replaceAll('"', "")
        .replaceAll("}", "")
        .replaceAll(":", "")
          ...
          try {
            ...
            fetch(mapurl, {
              ...
              .then((output3) => {
                ...
                fs.appendFileSync(linkfetchlogdir, "\n" + "");
                try {
                  let beatmapid = JSON.stringify(mapdata, ["id"])
                    .replaceAll("{", "")
                    .replaceAll('"', "")
                    .replaceAll("}", "")
                    .replaceAll(":", "")
                    .replaceAll("id", "");
                  let mapbg = JSON.stringify(mapdata["beatmapset"]["covers"], [
                    "cover",
                  ])
                    .replaceAll("{", "")
                    .replaceAll('"', "")
                    ...
                    .replace("cover", "")
                    .replace("https", "https:");
                  let mapper = JSON.stringify(mapdata["beatmapset"], [
                    "creator",
                  ])
                    .replaceAll("{", "")
                    .replaceAll('"', "")
                  ...
                  let mapperlink = JSON.stringify(mapper)
                    ...
                    .replaceAll("}", "")
                    .replaceAll(":", "");
                  let maptitle = JSON.stringify(mapdata["beatmapset"], [
                    "title_unicode",
                  ])
                    .replaceAll("{", "")
                    .replaceAll('"', "")
                  ...
                  let maptitlenormal = JSON.stringify(mapdata["beatmapset"], [
                    "title",
                  ])
                    .replaceAll("{", "")
                    .replaceAll('"', "")
...
*/
                  ...
                  let truaccbottom = Math.floor(
                    300 *
                      (nochoke300num + nochoke100num + nochoke50num + missnum)
                  );
                  ...
                  (async () => {
                    ...
                    let Embed = new Discord.MessageEmbed()
                      ...
                      .addField(
                        "**MAP**",
                        `[${fullmaptitle} \n[${mapdiff}]](https://osu.ppy.sh/b/${beatmapid}) ${modsifthere} mapped by [${mapper}](https://osu.ppy.sh/u/${mapperlink})`,
                        false
                      )
                      .addField(
                        "**MAP DETAILS**",
                    ...
                    chart
                      .toFile("./files/replayhealth.png")
                      .then((w) => {
                        let attachement = new Discord.MessageAttachment(
                          "./files/replayhealth.png",
                          "replayhealth.png"
                        );
                        message.reply({
                          embeds: [Embed],
                          files: ["./files/replayhealth.png"],
                        });
                      })
                      .catch((error) => {
                        fs.appendFileSync(linkfetchlogdir, "\n" + error);
                        ...
                        message.reply({
                          content:
                            "There was an error creating the health chart",
                          embeds: [Embed],
                          files: ["./files/error.png"],
                        });
                      });
                  })();
                  //})//mapdata2
