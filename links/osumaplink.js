  ...
  execute(
    ...
    fetch(mapurl, {
      ...
      .then((output2) => {
        ...
        try {
          let mapbg = JSON.stringify(mapdata["beatmapset"]["covers"], ["cover"])
            .replaceAll("{", "")
            .replaceAll('"', "")
            .replaceAll("}", "")
            .replaceAll(":", "")
          ...
          (async () => {
            ...
            let ppSSstr = parseFloat(JSON.stringify(ppSSjson["total"])).toFixed(
              2
            );
            let pp95str = parseFloat(JSON.stringify(pp95json["total"])).toFixed(
              2
            );
