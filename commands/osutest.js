...
module.exports = {
    ...
    execute(message, args, Discord, currentDate, currentDateISO, osuapikey, osuauthtoken, osuclientid, osuclientsecret) {
        ...
        try{
            ...
            .setTitle("Most recent play for " + rsplayername)
            .setImage(rsmapbg)
            .setDescription(`Score set on ${rsmaptime} by [${rsplayername}](https://osu.ppy.sh/u/${rsplayerid}) | https://osu.ppy.sh/u/${rsplayerid}\n[${rsmapname}](https://osu.pp.sh/b/${rsmapid}) [${rsdiffname}]+${rsmods} ${rsmapstar}⭐\n ${num} **${rsgrade}** | 300:${rs300s} 100:${rs100s} 50:${rs50s} 0:${rs0s} | ${rspp}pp\n`);
            message.reply({ embeds: [Embed]})
            message.reply(trueacc)
            }});
        } catch(err){
