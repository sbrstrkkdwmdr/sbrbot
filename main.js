...
const helpcmdfiles = fs
  .readdirSync("./commands-help/")
  .filter((file) => file.endsWith(".js") || file.endsWith(".ts"));
...
const ecchicmdfiles = fs
  .readdirSync("./commands-ecchi/")
  .filter((file) => file.endsWith(".js") || file.endsWith(".ts"));
...
const gamingcmdfiles = fs
  .readdirSync("./commands-gaming/")
  .filter((file) => file.endsWith(".js") || file.endsWith(".ts"));
