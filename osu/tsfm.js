                ...
                fetch(mapdataurl, {
                  ...
                  .then((output3) => {
                    ...
                    let mapdiff = JSON.stringify(mapdata, ["version"])
                      ...
                      .replaceAll(":", "")
                      .replaceAll("version", "");
                    let mapartist = JSON.stringify(mapdata["beatmapset"], [
                      "artist",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let mapper = JSON.stringify(mapdata["beatmapset"], [
                      ...
                      .replaceAll(":", "")
                      .replaceAll("creator", "");
                    let maptitleuni = JSON.stringify(mapdata["beatmapset"], [
                      "title_unicode",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let maptitlenorm = JSON.stringify(mapdata["beatmapset"], [
                      "title",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    for (i = 0; i < mapscoredata.scores.length; i++) {
                      let pp = JSON.stringify(mapscoredata["scores"][i], ["pp"])
                        .replaceAll("{", "")
                        .replaceAll('"', "")
                        .replaceAll("}", "")
                        .replaceAll(":", "")
                        .replaceAll("pp", "");
                      let grade = JSON.stringify(mapscoredata["scores"][i], [
                        "rank",
                      ])
                        .replaceAll("{", "")
                        .replaceAll('"', "")
                        ...
                        .replaceAll(":", "")
                        .replaceAll("rank", "");
                      let combo = JSON.stringify(mapscoredata["scores"][i], [
                        "max_combo",
                      ])
                        .replaceAll("{", "")
                        .replaceAll('"', "")
                      ...
                      let mods = JSON.stringify(mapscoredata["scores"][i], [
                        "mods",
                      ])
                        .replaceAll("{", "")
                        .replaceAll('"', "")
                        ...
                        .replaceAll("[", "")
                        .replaceAll("]", "");
                      let acc = JSON.stringify(mapscoredata["scores"][i], [
                        "accuracy",
                      ])
                        .replaceAll("{", "")
                        .replaceAll('"', "")
                        ...
                        .replaceAll(":", "")
                        .replaceAll("accuracy", "");
                      let mapscore0s = JSON.stringify(
                        mapscoredata["scores"][i]["statistics"],
                        ["count_miss"]
                      )
                        .replaceAll("{", "")
                        .replaceAll('"', "")
                      ...
                      let mapscore50s = JSON.stringify(
                        mapscoredata["scores"][i]["statistics"],
                        ["count_50"]
                      )
                        .replaceAll("{", "")
                        ...
                        .replaceAll(":", "")
                        .replaceAll("count_50", "");
                      let mapscore100s = JSON.stringify(
                        mapscoredata["scores"][i]["statistics"],
                        ["count_100"]
                      )
                        .replaceAll("{", "")
                      ...
                      let mapscore300s = JSON.stringify(
                        mapscoredata["scores"][i]["statistics"],
                        ["count_300"]
                      )
                        .replaceAll("{", "")
                      ...
                      let maptime = JSON.stringify(mapscoredata["scores"][i], [
                        "created_at",
                      ])
                        .replaceAll("{", "")
                        .replaceAll('"', "")
