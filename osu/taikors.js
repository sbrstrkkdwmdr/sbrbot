            ...
            .then(output1 => 
              ...
              //  let rsppw = rsdata[0]['pp'];
                ...
                (async () => {
                  ...
                  let pp = new taiko_ppv2().setPerformance(score);
                  if(rsmods){
                    pp = new taiko_ppv2().setPerformance(score).setMods(`${rsmods}`)
                }
                if(!rsmods){
                    pp = new taiko_ppv2().setPerformance(score).setMods('NM')
                }
