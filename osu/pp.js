          ...
          try {
            ...
            fetch(userinfourl, {
              ...
              .then((output3) => {
                ...
                if (
                  cpolmods.includes("rx") ||
                  cpolmods.includes("rl") ||
                  cpolmods.includes("rlx") ||
                  cpolmods.includes("RX") ||
                  cpolmods.includes("RL") ||
                  cpolmods.includes("RLX")
                ) {
                ...
                if (
                  cpolmods.includes("sv2") ||
                  cpolmods.includes("s2") ||
                  cpolmods.includes("SV2") ||
                  cpolmods.includes("S2")
                ) {
                  modenum += 536870912;
                ...
                fetch(cpolpp, {})
                  ...
                  .then((output4) => {
                    ...
                    let cppSS = JSON.stringify(output4["pp"], ["fc"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                      .replaceAll("fc", "");
                    let cpp95 = JSON.stringify(output4["pp"]["acc"], ["95"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
