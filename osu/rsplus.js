              ...
              try {
                ...
                fs.writeFile(fileName, JSON.stringify(file, null, 2), function writeJSON(err) {
                  ...
                  for (i = 0; i < 5; i++) {
                    ...
                    let rsdiffname = JSON.stringify(rsdata[i]["beatmap"], [
                      "version",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let rsmods = JSON.stringify(rsdata[i], ["mods"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                      ...
                      .replaceAll("[", "")
                      .replaceAll("]", "");
                    let rsacc = JSON.stringify(rsdata[i], ["accuracy"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                      .replaceAll("accuracy", "");
                    let rs0s = JSON.stringify(rsdata[i]["statistics"], [
                      "count_miss",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let rs50s = JSON.stringify(rsdata[i]["statistics"], [
                      "count_50",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      ...
                      .replaceAll(":", "")
                      .replaceAll("count_50", "");
                    let rs100s = JSON.stringify(rsdata[i]["statistics"], [
                      "count_100",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let rs300s = JSON.stringify(rsdata[i]["statistics"], [
                      "count_300",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let rsgeki = JSON.stringify(rsdata[i]["statistics"], [
                      "count_geki",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let rskatu = JSON.stringify(rsdata[i]["statistics"], [
                      "count_katu",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let rsmaptime = JSON.stringify(rsdata[i], ["created_at"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replace(":", "")
                      ...
                      .slice(0, 19)
                      .replaceAll("T", " ");
                    let rspp1 = JSON.stringify(rsdata[i], ["pp"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                    ...
                    let rsmapstar = JSON.stringify(rsdata[i]["beatmap"], [
                      "difficulty_rating",
                    ])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                    ...
                    let rsgrade = JSON.stringify(rsdata[i], ["rank"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                      .replaceAll("rank", "");
                    rsmapid = JSON.stringify(rsdata[i]["beatmap"], ["id"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                      .replaceAll("id", "");
                    let rscombo = JSON.stringify(rsdata[i], ["max_combo"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                      .replaceAll("max_combo", "");
                    let fc = JSON.stringify(rsdata[i], ["perfect"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                    ...
                    let fulltimeset1 = JSON.stringify(rsdata[i], ["created_at"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                      .replaceAll("created_at", "")
                      .slice(0, 18);
                    let fulltimeset2 = JSON.stringify(rsdata[i], ["created_at"])
                      .replaceAll("{", "")
                      .replaceAll('"', "")
                      .replaceAll("}", "")
                      .replaceAll(":", "")
                      .replaceAll("created_at", "")
                      .slice(0, 12);
                    let fulltimeset3 = JSON.stringify(fulltimeset1).slice(
                      12,
                      18
                    );
                    //fs.appendFileSync(osulogdir, "\n" + fulltimeset3)
                    ...
                    let minlastvisw =
                      lastvishours + "h " + lastvisminutes + "m";
                    fulltext += `**${
                      offsetflag + i + 1
                      ...
                      2
                    )}%** | **${rspp}**pp ${fcflag} | **${rsgrade}** | **${rscombo}x**\n${hitlist}\n\n`;
                  }
