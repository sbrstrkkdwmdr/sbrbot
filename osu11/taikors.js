...
const fs = require('fs');
const { taiko_ppv2 } = require('booba');
module.exports = {
    name: 'taikors',
    description: '',
    async execute(userdatatags, message, args, Discord, currentDate, currentDateISO, osuapikey, osuauthtoken, osuclientid, osuclientsecret) {
        ...
        console.log("command executed - taikors")
        ...
        console.log("") 
            ...
            .then(output1 => 
                ...
                const recentactiveurl = `https://osu.ppy.sh/api/v2/users/${playerid}/scores/recent?include_fails=1&mode=taiko&offset=0`;
              ...
              //  let rsppw = rsdata[0]['pp'];
                ...
                (async () => {
                  ...
                  fs.writeFileSync("debug/rsppcalc.json", JSON.stringify(score, null, 2));
                    let ppfc = new taiko_ppv2().setPerformance(score);
                    let pp =  new taiko_ppv2().setPerformance(scorenofc);
                    if(rsmods){
