...
console.log(
  "If you don't want to set an option, just put 'null' or press enter"
);
...
console.log("");
token = prompt(
  "Bot token  | https://discord.com/developers/applications create an application, go to bot, create bot and copy the token) |=>",
  "null"
);
console.log("");
googlecx = prompt(
  "Google cx  |  https://cdn.discordapp.com/attachments/824898253005914112/892674375646584862/HowTo.mp4 to get it |=>",
  "null"
);
console.log("");
googlekey = prompt(
  "Google key |  https://cdn.discordapp.com/attachments/824898253005914112/892674375646584862/HowTo.mp4 to get it |=>",
  "null"
);
console.log("");
oapi = prompt(
  "osu! api key |  grab it from https://osu.ppy.sh/p/api | just put anything as the name and url |=>",
  "null"
);
console.log("");
oclientid = prompt(
  "osu! client ID | In osu! profile settings, create an OAuth application and just set the name to whatever | copy the ID here |=>",
  "null"
);
console.log("");
oclientsecret = prompt(
  "osu! client secret | In osu! profile settings, create an OAuth application and just set the name to whatever | copy the client secret here |=>",
  "null"
);
console.log("");
joinroll = prompt(
  "Server verified role | Server settings > Roles > 3 dots >copy ID |=>",
  "null"
);
console.log("");
...
console.log("");
logchnl = prompt(
  "Channel to send logs to | Right click on channel > copy ID |=>",
  "null"
);
console.log("");
danserpath = prompt(
  "path to Danser | Double click on the address bar on the top and ctrl c |=>",
  "null"
);
console.log("");
recordchannel = prompt(
  "recording channel | Right click on channel > copy ID |=>",
  "null"
);
console.log("");
...
console.log("");
haloapikey = prompt(
  "token for https://autocode.com/lib/halo/infinite/ |  Go to https://autocode.com/lib/halo/infinite/, press Link and Authenticate, then copy Secret Token |=>",
  "null"
);
console.log("");
let template = {
