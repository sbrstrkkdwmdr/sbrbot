module.exports = (
  ...
  client.on("messageCreate", (message) => {
    ...
    switch (
      command //variable to check for
    ) {
      case "testingtypescript":
        client.commands
          .get("testingtypescript")
...
*/
    ...
    case 'gleave':case 'guildleave':case 'leaveguild':
      ...
      //gaming----
      case "profilesplitgate":
      case "splitgateprofile":
      ...
      default:
        ...
        console.log(
          `attempted command - ${command} ${undefinedargsbcsmiswrotecmd}`
        );
        console.log("");
        console.groupEnd();
        break;
